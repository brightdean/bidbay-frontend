...
const DashboardPage = () => {
    ...
    //                     <span className='text-[26px] font-semibold tracking-wide text-gray-700'>{auth.user.firstName} {auth.user.lastName}</span>
    //                     <span className='font-bold text-stone-500 text-[16px] tracking-wide -translate-y-2'>{auth.user.email}</span>
    //                 </div>
